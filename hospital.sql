...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2020 at 06:11 PM
...
(20190002, '2019-11-30', 'Joshua', 'Gualva', 'Tirona', 'June', 15, 1999, 'Male', 'O', 'joshua@yahoo.com', 'What\'s your favorite color?', 'Black', '+6398689596', '103 Sta Rita', 'Olongapo City', 'Zambales', 'Single', 'Joshua12', '1122'),
...
--
ALTER TABLE `billing`
  MODIFY `Bill_No` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `patient`
  MODIFY `Count` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
